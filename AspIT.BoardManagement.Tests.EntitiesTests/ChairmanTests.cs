...
namespace AspIT.BoardManagement.Tests.EntitiesTests
{
    ...
    public class ChairmanTests
    {
        ...
        public void CorrectInitialization()
        {
            ...
            // Act
            boardMember = new Chairman(new Person(firstName, lastName, birthDate, address, city, region, postalCode, country, contactInfo));
        ...
        public void IncorretStateThrows()
        {
            ...
            // Actsert
            Assert.ThrowsException<ArgumentException>(() => new Chairman(new Person(incorrectFirstName, correctLastName, correctBirthDate, correctAddress, correctCity, correctRegion, correctPostalCode, correctCountry, contactInfo)));
        }
        #endregion
        ...
        public void TestCorrectEquatable()
        {
            ...
            // Act
            bm1 = new Chairman(new Person(firstName, lastName, birthDate, address, city, region, postalCode, country, contactInfo));
            bm2 = new Chairman(new Person(firstName, lastName, birthDate, address, city, region, postalCode, country, contactInfo));
        ...
        public void TestIncorrectEquatable()
        {
            ...
            // Act
            bm1 = new Chairman(new Person(firstName, lastName, birthDate, address, city, region, postalCode, country, contactInfo));
            bm2 = new Chairman(new Person(1, firstName, lastName, birthDate, address, city, region, postalCode, country, contactInfo, userCredentials));
